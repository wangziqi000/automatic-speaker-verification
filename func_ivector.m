...
function [featureDict, ubm, T] = func_ivector(myFiles, nCoeffs, nMixtures, final_niter, tvDim, niter, ldaDim, niterlda)
%%
% Label speaker ID
...
%%
% mfcc for i-vector
% nCoeffs = 13;   % Coeffs num of MFCC = 13, coeffs length = nCoeffs + 1
...
nmix = nMixtures;
% final_niter = 10;   % max num of gmm iteration
...
% niterlda = 10;
pLDA = gplda_em(finalDevIVs, speakerID(:), nphi, niterlda);
disp('PLDA done');
...
%%
% Apply speaker model on all files, to extract features

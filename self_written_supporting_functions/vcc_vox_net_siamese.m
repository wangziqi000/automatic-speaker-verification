function[dist] = vcc_vox_net_siamese(snd1, snd2)
%% Set up VGGVox
...
%% Set up audio
    ...
    snd1 = resample(snd1, 320, 441); % from 22050 to 16000 
    snd2 = resample(snd2, 320, 441); % from 22050 to 16000 
    ...
    inp1 = test_getinput_modified(snd1, net.meta, buckets);
    inp2 = test_getinput_modified(snd2, net.meta, buckets);
    ...
    net.eval({ 'data_b1', inp1, 'data_b2', inp2 });
